    ...
    for irun = 1:numel(avail_runs)
        ...
        for icond = 1:2
            ...
            for i = 1:num_chunks
                ...
                eigenvalues = latent; % Since latent contains PCA eigenvalues
                effective_dimensionality = (sum(eigenvalues)^2) / sum(eigenvalues.^2);

                % Store the effective dimensionality for each chunk
                explained_variances(i, :) = effective_dimensionality;
