...
settings.bs_period_ripple       = [-1.5 -1; 1.5 1]; % [-.5 -.1]
...
%         randtrials_correct = circshift(1:size(trl_ripple_correct,1),1);
    ...
    for icond = 1:2
        ...
        if icond == 1
            perf{isubject}.colour.correct.accuracy(ishuffle,:,:)         = accuracy;
            perf{isubject}.colour.correct.trl_num_train    = [numel(find(clabelTraining==1)),numel(find(clabelTraining==2))];
        elseif icond == 2
            perf{isubject}.colour.incorrect.accuracy(ishuffle,:,:)       = accuracy;
    ...
    for icond = 1:2
        ...
        if icond == 1
            ...
            perf{isubject}.scene.correct.accuracy(ishuffle,:,:)         = accuracy;
            perf{isubject}.scene.correct.trl_num_train    = [numel(find(clabelTraining==1)),numel(find(clabelTraining==2))];

        elseif icond == 2

            perf{isubject}.scene.incorrect.accuracy(ishuffle,:,:)       = accuracy;
...
perf{isubject}.colour.correct.accuracy      = perf{isubject}.colour.correct.accuracy;
perf{isubject}.colour.incorrect.accuracy    = perf{isubject}.colour.incorrect.accuracy;
perf{isubject}.scene.correct.accuracy       = perf{isubject}.scene.correct.accuracy;
perf{isubject}.scene.incorrect.accuracy     = perf{isubject}.scene.incorrect.accuracy;
